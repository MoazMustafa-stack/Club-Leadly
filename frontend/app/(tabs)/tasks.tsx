...
const styles = StyleSheet.create({
  ...
  pillText: { fontSize: 14, fontWeight: "600", color: "#888", fontFamily: "InstrumentSans_700Bold" },
  pillTextActive: { color: "#FFFFFF" },
  list: { padding: 20, paddingBottom: 100 },
  empty: { alignItems: "center", marginTop: 80 },
  emptyText: { color: "#9CA3AF", fontSize: 16, marginTop: 12, fontFamily: "GentiumPlus_400Regular" },
  fab: {
    position: "absolute",
    bottom: 24,
    right: 20,
